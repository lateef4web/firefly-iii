                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="transaction_currency_id" name="transaction_currency_id" class="form-control" value="{{ old('transaction_currency_id', $primaryCurrency->id ?? '') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="amount_min" class="form-label">{{ __('firefly.amount_min') }}</label>
                                    <input type="number" step="any" id="amount_min" name="amount_min" class="form-control" value="{{ old('amount_min') }}">
                                </div>
                                <div class="mb-3">
                                    <label for="amount_max" class="form-label">{{ __('firefly.amount_max') }}</label>
                                    <input type="number" step="any" id="amount_max" name="amount_max" class="form-control" value="{{ old('amount_max') }}">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="repeat_freq" name="repeat_freq" class="form-select">
                                        @foreach($periods as $period)
                                            <option value="{{ $period }}" @selected(old('repeat_freq')===$period)>{{ trans('firefly.repeat_freq_' . $period) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="skip" class="form-label">{{ __('firefly.skip') }}</label>
                                    <input type="number" id="skip" name="skip" class="form-control" value="{{ old('skip', 0) }}">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col text-end">
                                        <button type="submit" class="btn btn-success">{{ __('firefly.store_new_bill') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
